...
import { Card, Accordion, AccordionCollapse, Button, Container, Row, Col, Image, Input } from 'react-bootstrap';
...
const Products = props => {
  ...
  let cartList = cart.map((item, index) => {
    let key = 1 + index;
    const result = (
      <Card key={index} onClick={e => deleteCartItem(index)} eventKey={1 + index}>
        <Card.Header>
